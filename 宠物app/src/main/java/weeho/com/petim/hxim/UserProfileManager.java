...
public class UserProfileManager {
	 ...
	 */
	private List<HxHelper.DataSyncListener> syncContactInfosListeners;
	...
	public synchronized boolean init(Context context) {
		...
		syncContactInfosListeners = new ArrayList<HxHelper.DataSyncListener>();
		sdkInited = true;
		return true;
	}

	public void addSyncContactInfoListener(HxHelper.DataSyncListener listener) {
		if (listener == null) {
			return;
		}
	...
	public void removeSyncContactInfoListener(HxHelper.DataSyncListener listener) {
		if (listener == null) {
			return;
		}
		if (syncContactInfosListeners.contains(listener)) {
	...
	public void notifyContactInfosSyncListener(boolean success) {
		for (HxHelper.DataSyncListener listener : syncContactInfosListeners) {
