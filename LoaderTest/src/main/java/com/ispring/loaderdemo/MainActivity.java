...
//为了在Android 3.0之前使用Loader，我们让MainActivity继承自android.support.v4.app.FragmentActivity
public class MainActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<Cursor>, TextWatcher {
